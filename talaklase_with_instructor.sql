...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2026 at 02:07 AM
...
(2, 'Accountancy Management Department'),
(3, 'College of Criminal Justice Education'),
(4, 'Education Department'),
(5, 'Hotel Institute Management');
...
INSERT INTO `section` (`sectionID`, `section`, `course_id`, `inst_id`) VALUES
(1, 'Xiaomi', 1, NULL),
(2, 'TaskUs', 1, NULL),
(3, 'Everise', 1, NULL),
(4, 'sample', 1, 8);
...
(112, 'Sample', 'Sample', 'Sample', '', 'Female', 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `username`, `password_hash`, `role`, `inst_id`, `is_active`, `created_at`) VALUES
(1, 'Administrator', NULL, 'admin', '$2y$10$wBSXdQ7ov1UC72tmL4cuF.2K1tv.0uggVbrGjY5Bg01lvGEXkwjsC', 'admin', NULL, 1, '2026-06-13 04:54:28'),
(2, 'kat', 'katrinamicaellabarbosa@gmail.com', 'katrinamicaellabarbosa@gmail.com', '$2y$10$z1hQ6F7PZaheLtimPjWScegJaShC5g3PWiiqdNqfMqn75hP1lBVQa', 'instructor_admin', 8, 1, '2026-06-16 20:14:09');
...
--
ALTER TABLE `section`
  MODIFY `sectionID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `student`
--
ALTER TABLE `student`
  MODIFY `st_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `student_section`
  MODIFY `stsec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
