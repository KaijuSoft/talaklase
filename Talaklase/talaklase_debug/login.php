...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf()) {
        ...
        if (empty($errors)) {
            $stmt = $pdo->prepare(
                'SELECT id, name, username, password_hash, role, inst_id, is_active
    ...
    <div class="brand">
      <div class="star-wrap" aria-hidden="true">
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          <polygon points="13,1.5 15.9,9.5 24.5,9.5 17.8,14.7 20.2,22.7 13,18 5.8,22.7 8.2,14.7 1.5,9.5 10.1,9.5"
                   stroke="#1D9E75" stroke-width="1.5" stroke-linejoin="round" fill="rgba(29,158,117,0.12)"/>
        </svg>
      </div>
      <div class="wordmark"><span class="tala">Tala</span><span class="klase">Klase</span></div>
      <div class="dept-label">Computer Studies Department</div>
      <div class="role-row" aria-hidden="true">
